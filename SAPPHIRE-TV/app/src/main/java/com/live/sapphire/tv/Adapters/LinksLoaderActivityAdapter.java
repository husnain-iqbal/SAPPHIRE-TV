...
public class LinksLoaderActivityAdapter extends RecyclerView.Adapter <LinksLoaderActivityAdapter.ViewHolder> {
    ...
    public LinksLoaderActivityAdapter(SendData sendData, Activity activity, ArrayList <LinkInfoContainer> inLinksInfoLint){
//        mActivity = activity;
