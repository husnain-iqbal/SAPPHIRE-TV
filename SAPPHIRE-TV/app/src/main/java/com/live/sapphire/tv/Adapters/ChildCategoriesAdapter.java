...
public class ChildCategoriesAdapter extends RecyclerView.Adapter <ChildCategoriesAdapter.ViewHolder> {
    //    private Activity mActivity;
    private Context mContext;
    private SendData mSendData;
    private final ArrayList <ChildCategoryInfo> mChildCategoryInfoList;


    public ChildCategoriesAdapter(SendData sendData, Activity activity, ArrayList <ChildCategoryInfo> infoList){
//        mActivity = activity;
        mContext = activity.getApplicationContext();
        mSendData = sendData;
        mChildCategoryInfoList = infoList;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position){
        viewHolder.bind(mChildCategoryInfoList.get(position), position);
    }
    ...
    public int getItemCount(){
        return mChildCategoryInfoList.size();
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final ChildCategoryInfo info, final int position){
            button.setText(info.getChildCategoryName());
...
//                                return false;
                            ...
                            mSendData.sendData2NewScreen(mChildCategoryInfoList.get(position));
                            return true;
                        }
