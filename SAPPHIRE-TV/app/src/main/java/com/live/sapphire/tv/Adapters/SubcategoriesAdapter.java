...
public class SubcategoriesAdapter extends RecyclerView.Adapter <SubcategoriesAdapter.ViewHolder> {
    ...
    private final ArrayList <SubcategoryInfo> mSubcategoryInfoList;


    public SubcategoriesAdapter(SendData sendData, Activity activity, ArrayList <SubcategoryInfo> subcategoryInfos){
//        mActivity = activity;
        mContext = activity.getApplicationContext();
        mSendData = sendData;
        mSubcategoryInfoList = subcategoryInfos;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position){
        viewHolder.bind(mSubcategoryInfoList.get(position), position);
    }
    ...
    public int getItemCount(){
        return mSubcategoryInfoList.size();
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final SubcategoryInfo info, final int position){
            button.setText(info.getSubcategoryName());
...
//                                return false;
                            ...
                            mSendData.sendData2NewScreen(mSubcategoryInfoList.get(position));
                            return true;
                        }
                    }
