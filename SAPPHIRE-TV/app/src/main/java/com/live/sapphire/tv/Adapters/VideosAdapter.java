...
public class VideosAdapter extends RecyclerView.Adapter <VideosAdapter.ViewHolder> {
    ...
    public VideosAdapter(SendData sendData, Activity activity, ArrayList <VideoInfo> videoInfos){
//        mActivity = activity;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position){
        viewHolder.bind(mVideoList.get(position), position);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final VideoInfo info, final int position){
...
//                                return false;
                            ...
                            mSendData.sendData2NewScreen(mVideoList.get(position));
                            return true;
                        }
    ...
    public interface SendData {
        void sendData2NewScreen(VideoInfo info);
