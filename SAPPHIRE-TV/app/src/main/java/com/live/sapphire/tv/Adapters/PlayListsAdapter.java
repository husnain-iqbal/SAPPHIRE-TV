...
public class PlayListsAdapter extends RecyclerView.Adapter <PlayListsAdapter.ViewHolder> {
    ...
    private final ArrayList <PlayListsInfo> mPlayListArrayList;


    public PlayListsAdapter(SendData sendData, Activity activity, ArrayList <PlayListsInfo> playlist){
//        mActivity = activity;
        mContext = activity.getApplicationContext();
        mSendData = sendData;
        mPlayListArrayList = playlist;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position){
        ...
        viewHolder.bind(mPlayListArrayList.get(position), position);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final PlayListsInfo info, final int position){
...
//                                return false;
                            ...
                            mSendData.sendData2NewScreen(mPlayListArrayList.get(position));
                            return true;
                        }
    ...
    public interface SendData {
        void sendData2NewScreen(PlayListsInfo info);
